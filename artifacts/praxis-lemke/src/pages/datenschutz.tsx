          ...
          <FadeIn>
            <article className="max-w-3xl space-y-10 text-sm leading-7 text-foreground/75 sm:text-base sm:leading-8 [&_a]:text-[#00A8CC] [&_a]:underline [&_a]:underline-offset-4 [&_h2]:mt-10 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:tracking-tight [&_h2]:text-foreground [&_h3]:mt-7 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-foreground [&_p]:mt-3 [&_ul]:mt-3 [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-5">
              <section aria-labelledby="datenschutz-auf-einen-blick">
                <h2 id="datenschutz-auf-einen-blick">
              ...
              <section aria-labelledby="pflichtinformationen">
                ...
                <p>
                  ...
                  Daten nur dann an externe Stellen weiter, wenn dies im Rahmen
                  einer Vertragserfüllung erforderlich ist, wenn wir gesetzlich
                ...
                <ul>
                  <li>
                    ...
                    Regel Zeit, um dies zu überprüfen.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    unseren Interessen vorgenommen werden.
                  </li>
                </ul>
                <p>
              ...
              <section aria-labelledby="datenerfassung">
                ...
                <p>
                  ...
                  andere Rechtsgrundlage angegeben wird. Sofern eine
                ...
                <p>
                  Auf unserer Website stellen wir einen passwortgeschützten
                  Bereich zur Verfügung, über den Patienten
                  Informationsmaterialien und Testunterlagen herunterladen
                  können. Der Zugang ist ausschließlich autorisierten Personen
                  vorbehalten. Im Rahmen der Nutzung werden technisch
                  erforderliche Daten (z. B. IP-Adresse, Zeitpunkt des Zugriffs
                  und Server-Logdaten) verarbeitet, soweit dies zur
                  Bereitstellung und Sicherheit des geschützten Bereichs
                  erforderlich ist. Die Verarbeitung erfolgt auf Grundlage von
                  Art. 6 Abs. 1 lit. f DSGVO. Sofern im Einzelfall
                  personenbezogene oder besondere Kategorien personenbezogener
                  Daten verarbeitet werden, erfolgt dies ausschließlich im
              ...
              <section aria-labelledby="plugins-tools">
                ...
                <p>
                  ...
                  Kartenmaterial auf unserer Website einbinden. Google Maps wird
                  auf dieser Website nicht automatisch geladen, sondern erst
                  nach Ihrer aktiven Zustimmung über die Zwei-Klick-Lösung im
                  Kontaktbereich.
                </p>
                <p>
                  ...
                  dort gespeichert. Die Nutzung von Google Maps erfolgt im
                ...
                <p>
                  Details zu den Standardvertragsklauseln finden Sie unter{" "}
                  <a
                ...
                <p>
                  Auf unserer Website können Links zu externen Terminbuchungs-
                  oder Praxissoftware-Anbietern, zum Beispiel Patientify oder
                  Doctolib, eingebunden sein. Wenn Sie einen solchen Link
                  anklicken, verlassen Sie unsere Website. Für die Verarbeitung
                  personenbezogener Daten auf der Zielseite ist der jeweilige
                  Anbieter verantwortlich. Bitte beachten Sie die
