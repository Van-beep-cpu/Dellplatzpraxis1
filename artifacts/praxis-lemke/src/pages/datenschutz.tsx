    ...
    <>
      ...
      <section className="pb-20 md:pt-10 md:pb-28 pt-[0px]">
        <div className="container mx-auto px-4 md:px-8">
          <FadeIn>
            <article className="max-w-3xl space-y-10 text-sm leading-7 text-foreground/75 sm:text-base sm:leading-8 [&_a]:text-[#00A8CC] [&_a]:underline [&_a]:underline-offset-4 [&_h2]:mt-10 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:tracking-tight [&_h2]:text-foreground [&_h3]:mt-7 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-foreground [&_p]:mt-3 [&_ul]:mt-3 [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-5">
              <section aria-labelledby="datenschutz-auf-einen-blick">
              ...
              <section aria-labelledby="hosting">
                ...
                <p>
                  Weitere Informationen entnehmen Sie der Datenschutzerklärung von Strato: <a href="https://www.strato.de/datenschutz/" {...externalLinkProps}>https://www.strato.de/datenschutz/</a>.
                </p>
                <p>
              ...
              <section aria-labelledby="pflichtinformationen">
                ...
                <p className="font-semibold uppercase text-foreground/80">
                ...
                <ul>
                  ...
                  <li>Wenn Sie einen Widerspruch nach Art. 21 Abs. 1 DSGVO eingelegt haben, muss eine Abwägung zwischen Ihren und unseren Interessen vorgenommen werden.</li>
                </ul>
                <p>
              ...
              <section aria-labelledby="plugins-tools">
                <h2 id="plugins-tools">5. Plugins und Tools</h2>
                <h3>Google Fonts (lokales Hosting)</h3>
                <p>
                  Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten so genannte Google Fonts, die von Google bereitgestellt werden. Die Google Fonts sind lokal installiert. Eine Verbindung zu Servern von Google findet dabei nicht statt.
                </p>
                <p>
                  Weitere Informationen zu Google Fonts finden Sie unter <a href="https://developers.google.com/fonts/faq" {...externalLinkProps}>https://developers.google.com/fonts/faq</a> und in der Datenschutzerklärung von Google: <a href="https://policies.google.com/privacy?hl=de" {...externalLinkProps}>https://policies.google.com/privacy?hl=de</a>.
                </p>
                <h3>Google Maps</h3>
                <p>
                  Diese Seite nutzt den Kartendienst Google Maps. Anbieter ist die Google Ireland Limited („Google“), Gordon House, Barrow Street, Dublin 4, Irland. Mit Hilfe dieses Dienstes können wir Kartenmaterial auf unserer Website einbinden. Google Maps wird auf dieser Website nicht automatisch geladen, sondern erst nach Ihrer aktiven Zustimmung über die Zwei-Klick-Lösung im Kontaktbereich.
                </p>
                <p>
                ...
                <p>
                  Details zu den Standardvertragsklauseln finden Sie unter <a href="https://privacy.google.com/businesses/gdprcontrollerterms/" {...externalLinkProps}>https://privacy.google.com/businesses/gdprcontrollerterms/</a> und <a href="https://privacy.google.com/businesses/gdprcontrollerterms/sccs/" {...externalLinkProps}>https://privacy.google.com/businesses/gdprcontrollerterms/sccs/</a>. Mehr Informationen zum Umgang mit Nutzerdaten finden Sie in der Datenschutzerklärung von Google: <a href="https://policies.google.com/privacy?hl=de" {...externalLinkProps}>https://policies.google.com/privacy?hl=de</a>.
                </p>
                <p>
                  Das Unternehmen verfügt über eine Zertifizierung nach dem „EU-US Data Privacy Framework“ (DPF). Weitere Informationen hierzu erhalten Sie vom Anbieter unter folgendem Link: <a href="https://www.dataprivacyframework.gov/participant/5780" {...externalLinkProps}>https://www.dataprivacyframework.gov/participant/5780</a>.
                </p>
                <h3>Externe Links zur Terminbuchung</h3>
                <p>
                  Auf unserer Website können Links zu externen Terminbuchungs- oder Praxissoftware-Anbietern, zum Beispiel Patientify oder Doctolib, eingebunden sein. Wenn Sie einen solchen Link anklicken, verlassen Sie unsere Website. Für die Verarbeitung personenbezogener Daten auf der Zielseite ist der jeweilige Anbieter verantwortlich. Bitte beachten Sie die Datenschutzhinweise des jeweiligen Anbieters.
                </p>
              </section>

              <p className="pt-4 text-xs text-foreground/45">Quelle: <a href="https://www.e-recht24.de" {...externalLinkProps}>https://www.e-recht24.de</a></p>
            </article>
          </FadeIn>
        </div>
      </section>
