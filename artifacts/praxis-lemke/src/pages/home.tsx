        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <FadeIn>
              ...
              <p className="text-lg text-foreground/80 leading-relaxed">In meiner Praxis in Duisburg begleite ich Sie bei psychischen und psychosomatischen Beschwerden mit einem ganzheitlichen Ansatz. Dabei betrachte ich nicht nur einzelne Symptome, sondern beziehe auch psychologische und soziale Aspekte in die Behandlung mit ein. Gemeinsam schauen wir, welcher Therapie- oder Behandlungsansatz für Ihre persönliche Situation am sinnvollsten ist. Falls erforderlich, kann die Behandlung auch medikamentös unterstützt werden, stets in enger Abstimmung mit Ihnen. Ein besonderer Schwerpunkt liegt unter anderem in der Behandlung von Depressionen, Suchterkrankungen sowie chronischen Schmerzsymptomen. Ich freue mich darauf, Sie kennenzulernen.</p>
            </FadeIn>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            <FadeIn delay={0.2}>
              ...
              <p className="text-lg text-foreground/80 mb-6 leading-relaxed">Nach über 20 Jahren medizinischer und persönlicher Entwicklung kehre ich in meine Heimatstadt Duisburg zurück. Mein beruflicher Weg hat mich über viele Stationen geführt und mich in meiner Arbeit wie auch persönlich geprägt.

              In meiner Praxis verbinde ich medizinisches Fachwissen mit einem Verständnis für die individuellen Lebenssituationen meiner Patienten.

              Ich nehme mir Zeit für Sie. Eine sorgfältige Diagnostik und eine auf Ihre Bedürfnisse abgestimmte Therapieplanung bilden die Grundlage unserer gemeinsamen Arbeit.</p>
