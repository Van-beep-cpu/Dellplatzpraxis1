          ...
          <div className="max-w-3xl">
            <FadeIn>
              ...
              <p className="text-lg text-foreground/70 leading-loose mb-5">
                ...
                neurobiologische Erkrankung, die häufig bereits in der Kindheit
                beginnt, jedoch oft erst im Erwachsenenalter diagnostiziert
                wird. Viele Betroffene berichten von anhaltenden Schwierigkeiten
                bei der Konzentration, Organisation und Impulskontrolle.
              </p>
              <p className="text-lg text-foreground/70 leading-loose">
                In meiner Praxis führe ich eine sorgfältige Diagnostik durch und
                entwickle gemeinsam mit Ihnen einen individuellen
                Behandlungsplan – ob medikamentös, therapeutisch oder in
                Kombination. Ziel ist es, Ihre Stärken zu fördern und
                alltagspraktische Strategien zu entwickeln, die wirklich zu
                Ihnen passen.
              </p>
            </FadeIn>
